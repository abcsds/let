          ...
          <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
              <ul class="nav navbar-nav navbar-right">
                  <li>
                      <a class="page-scroll" href="http://let-emprendimientopublico.mx/">Inicio</a>
                  </li>
            <?php
            $args = array(
            	'sort_order' => 'DESC',
            ...
            <?php
                ...
                <li>
                    <a class="page-scroll mini" href="http://let-emprendimientopublico.mx/mecate-en">ENGLISH</a>
                </li>
            </ul>
          <div>
            <!-- /.navbar-collapse -->
